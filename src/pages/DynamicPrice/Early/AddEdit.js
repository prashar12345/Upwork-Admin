        ...
        <Layout>
            <form onSubmit={handleSubmit}>
                <div className="pprofile1">
                    <h3 className="ViewUser mb-3">{form && form.id && copy == 'false' ? 'Edit' : 'Add'} Early Bird Pricing Custom Dates </h3>
                    <div className="form-row">
                        ...
                        <div className="col-md-12 mb-3">
                            <label>Add Block out Dates or Date Range </label>
                            <div className="row">
                                ...
                                {submitted && !date.length ? <div className="text-danger">Black Out Dates Range is Required</div> : <></>}
                        ...
                        {/* <div className="col-md-6 mb-3">
                            ...
                            <div>
                                <div className='d-flex dayCheckbox'>
