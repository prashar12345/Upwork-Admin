    ...
    return (
        <Layout>
            <div className="text-right">
                <div>
                <i onClick={e=>history.push(`/AddEditspeciality/${id}`)} class="material-icons edit mr-3" title="Edit">edit</i>
                    <a to="/speciality" onClick={back}>  <i className="fa fa-arrow-left mr-4 mb-3 " title='Back' aria-hidden="true"></i></a>
                </div>
            </div>
            <div className="row">
