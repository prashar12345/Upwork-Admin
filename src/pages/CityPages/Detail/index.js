    ...
    return (
        <Layout>
            <div className="text-right">
                <div>
                    <a to="/cities" onClick={back}>  <i className="fa fa-arrow-left mr-4 mb-3 " title='Back' aria-hidden="true"></i></a>
                </div>
            </div>
            <div className="row">
                <div className="sideclass col-md-12">
                    ...
                    <div className="form-row">
                        ...
                        <div className="col-md-6 mb-3">
                            <label className="profileheddingcls">Region</label>
                            <div className='profiledetailscls'>{data && data.region}</div>
                        </div>
                        <div className="col-md-6 mb-3">
                            <label className="profileheddingcls">Country</label>
                            <div className='profiledetailscls'>{data && data.country}</div>
                        </div>
                        <div className="col-md-6 mb-3">
