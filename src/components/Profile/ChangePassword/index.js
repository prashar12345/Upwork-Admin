...
const ChangePassword = p => {
  ...
  return (
    <>
      <form
        className="pprofile1 form-row py-3 w-50 mx-auto "
        ...
        <h3 className='ViewUser mb-3'>Change Password</h3>
          ...
          <div className="inputWrapper">
            <input
              ...
              required
            />
            <i className={eyes.currentPassword ? 'fa fa-eye eyei_con' : 'fa fa-eye-slash eyei_con'} onClick={() => setEyes({ ...eyes, currentPassword: !eyes.currentPassword })}></i>
          </div>
